  ...
  const todaysAppts = useMemo(() => {
    return (appointments || [])
      .filter((a) => {
        ...
        // Strong match: doctorId OR doctorEmail OR doctorName
        ...
        const matchesDoc = matchesByDoctorId || matchesByEmail || matchesByName;

        return isToday && matchesDoc;
      })
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: 12, marginTop: 12 }}>
          ...
          <Card
            icon="👥"
            title="Patients"
            subtitle={`${patients.length} today`}
            onPress={() => {}}
          />
        </View>
        ...
        <Text style={{ marginTop: 18, fontSize: 16, fontWeight: "900" }}>
          Patient List (Today)
        </Text>
